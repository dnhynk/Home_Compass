/* ============================================================
   ...
   이 파일이 없거나 로드에 실패하면 window.FIRSTHOME_CONTRACT_CONSTANTS 은 undefined 다.
   소비자는 그 자리에서 로컬 판정 경로를 끄고 화면에 명시한다 — 기본값으로 메우는
   침묵 폴백을 금지한다 (SPEC D-11 · 6.2 오프라인 동작 정의 #3).
   ============================================================ */
window.FIRSTHOME_CONTRACT_CONSTANTS = {
  "$generated": {
    "artifact": "web-contract-constants",
    "command": "python scripts/gen_contracts.py",
    "doNotEdit": true,
    "engineVersion": "3.0.0",
    "global": "FIRSTHOME_CONTRACT_CONSTANTS",
    "noSilentFallback": "이 파일이 없으면 window.FIRSTHOME_CONTRACT_CONSTANTS 은 undefined 다. 기본값·빈 값으로 대체하지 않는다. 판정 경로를 끄고 화면에 명시한다 (SPEC D-11).",
